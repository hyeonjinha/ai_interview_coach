...
export default function NewJobPage() {
  ...
  const createMutation = useMutation({
    ...
    onError: (error: any) => {
      const errorMessage = error.response?.data?.detail || '공고 등록에 실패했습니다.';
    ...
    <div className="p-6">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold text-text-primary">새 공고 등록</h1>
          <p className="text-text-secondary">채용 공고 정보를 단계별로 입력하세요</p>
        </div>
      </div>
        ...
        {currentStep === 1 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                채용 공고의 기본 정보를 입력하거나 URL에서 가져오세요
              </CardDescription>
            </CardHeader>
        ...
        {currentStep === 2 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                채용 공고의 상세 내용을 입력하세요 (주요 업무, 자격 요건, 우대 사항 등)
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Textarea
